export class Config {
  ...
  static readonly NEED_EXP = [
    ...
    102799, 111023, 119905, 129497, 139857, 151046, 163130, 176180, 190274,
    205496, 221936, 239691, 258866, 279575, 301941, 326096, 352184, 380359,
    410788, 433651, 479143, 479143, 479143, 479143, 479143, 479143, 512683,
    548571, 586971, 629059, 672023, 719065, 769400, 823258, 880886, 943548,
    1008526, 1079123, 1154662, 1235448, 1321372, 1414510, 1513516, 1619473,
    1732836, 1854135, 1983924, 2122799, 2271395, 2430393, 2600521,
  ];
  ...
  static getNeedExp(level: number) {
  ...
  static getDefaultPort(): number {
    ...
    if (!serverPort) {
      ...
      const customPort = parseInt(serverPort);
      if (!customPort) {
        return this.DEFAULT_PORT;
      } else {
        return customPort;
